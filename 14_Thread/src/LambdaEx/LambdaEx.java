...
/*
 람다식 ( Lambda)
 클래식으로 구분해서 만드는 함수를 하나의 식으로 표현한 것
 ...
 */
public class LambdaEx {public static void main(String[] args) {
	 private static int 숫자=0;
	 
	 /*public void 기본스레드() { //러너블연습.java + 러너블실행.java를 합친것
		 for(int i=0; i<3; i++) {
 ...
 public void 람다스레드 () {
	 for(int i=0; i<5; i++) { //러너블 인터페이스 생략 vod run 
		 Thread t = new Thread(( )->{
			 synchronized(LambdaEx.class) {
				 숫자++;
				 System.out.println("숫자 :"+숫자);
