...
public class DateEx {
	...
	public static void main(String[] args) {
		...
		/*
		 3. 그레고리안 
		 그레고리안 달력은 1년 1월 1일 무조건 월요일로 정의되어있음 
		 2024, 4, 23 을 하면 자동으로 2024년5월23일로 변경됨
		 2024년 5월 23일은 목요일 
		 */
		
		GregorianCalendar 그레고리안1 = new GregorianCalendar();
		GregorianCalendar 그레고리안2= new GregorianCalendar(2024,4,23);// 2024 5월 23일?
		int 날짜 = 그레고리안2.get(Calendar.DAY_OF_WEEK);//일요일부터 1 월 2 화 3 수 4 목 5 금6 토7
