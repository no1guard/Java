...
/*
 Arrays
 	배열과 관련된 다양한 직업을 쉽게 처리할 수 있도록 도와줌 
 	정렬 , 복사 , 비교
 메소드
 sort() : 배열을 정렬 
...
public class ArraysEx {
	...
	// 두 배열이 똑같이 생겼는지 확인하기 
			// num 과 abc가 똑같이 새겼는지 확인만 하는 것
	boolean smae = Arrays.equals(num, abc);//순서 상관 없음 
	System.out.println("num과 abc는 똑같나요 : "+ smae);
