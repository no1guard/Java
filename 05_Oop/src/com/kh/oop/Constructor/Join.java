...
public class Join {
	...
	public Join(int memberNo,String memberId,String memberName,String phoneNumber) {// 필수 o 우리 회사에서 필요한 내용을 모두 담을것 
	...
	//메서드 = 클래스 안에 존재하고 , 특정 기능을 할 수 있또록 묶어놓은 코드 모음 
