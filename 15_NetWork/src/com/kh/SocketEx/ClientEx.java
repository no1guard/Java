...
public class ClientEx {
	public static void main(String[] args) {
		...
		try {
			// 				localhost=127.0.01 으은 내 컴퓨터주소라는 의미 
			//
			//							접숙하고자 하는 컴퓨터 주소  서버의 포트 번호 
			...
			//3. BuffereReader : 하나씩 된 데이터를 한 번에 가져오고 읽을 수 있도록 도와줌
			...
			//2. printWriter() : 텍스트를 출력하는데 불편함 없이 매끄럽게 출력하는데 도와줌 
			//					 flush() : 강제로 출력하는 역할  <- true 포함되어있음 
